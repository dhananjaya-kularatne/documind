...
import { askQuestion, deleteDocument } from "../api/documents"
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] flex flex-col md:flex-row">
      ...
      <div
        ...
        } absolute md:static bg-[#FAF9F6] z-10 h-full md:h-auto`}
      >
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-xs font-mono text-[#6B6862]">This session</h2>
          <button
            onClick={() => setShowSidebar(false)}
            className="md:hidden text-[#6B6862] cursor-pointer hover:text-red-600"
        ...
        <header className="border-b border-[#DDD9D2] px-4 py-3 flex items-center justify-between relative z-20 bg-[#FAF9F6]">
          <div className="flex items-center gap-3">
            <button
              ...
              className="md:hidden text-xs text-[#6B6862] cursor-pointer hover:text-[#2A5B8C]"
